...
func explanation(instruction uint16) string {
	...
	regExp_2NNN := regexp.MustCompile("2(\\w\\w\\w)")
	regExp_3XNN := regexp.MustCompile("3(\\w)(\\w\\w)")
	regExp_4XNN := regexp.MustCompile("4(\\w)(\\w\\w)")
	regExp_5XY0 := regexp.MustCompile("5(\\w)(\\w)0")
	regExp_6XNN := regexp.MustCompile("6(\\w)(\\w\\w)")
	regExp_7XNN := regexp.MustCompile("7(\\w)(\\w\\w)")
	regExp_8XY0 := regexp.MustCompile("8(\\w)(\\w)0")
	regExp_8XY1 := regexp.MustCompile("8(\\w)(\\w)1")
	regExp_8XY2 := regexp.MustCompile("8(\\w)(\\w)2")
	regExp_8XY3 := regexp.MustCompile("8(\\w)(\\w)3")
	regExp_8XY4 := regexp.MustCompile("8(\\w)(\\w)4")
	regExp_8XY5 := regexp.MustCompile("8(\\w)(\\w)5")
	regExp_8XY6 := regexp.MustCompile("8(\\w)(\\w)6")
	regExp_8XYE := regexp.MustCompile("8(\\w)(\\w)E")
	regExp_9XY0 := regexp.MustCompile("9(\\w)(\\w)0")
	regExp_ANNN := regexp.MustCompile("A(\\w\\w\\w)")
	regExp_BNNN := regexp.MustCompile("B(\\w\\w\\w)")
	regExp_DXYN := regexp.MustCompile("D(\\w)(\\w)(\\w)")
	regExp_FX33 := regexp.MustCompile("F(\\w)33")
	regExp_FX55 := regexp.MustCompile("F(\\w)55")
	regExp_FX65 := regexp.MustCompile("F(\\w)65")
	...
	if regExp_2NNN.MatchString(instructionText) {
		matches := regExp_2NNN.FindStringSubmatch(instructionText)
		return fmt.Sprintf("2NNN: Jump to subroutine at address 0x%s", matches[1])
	}

	if regExp_3XNN.MatchString(instructionText) {
		matches := regExp_3XNN.FindStringSubmatch(instructionText)
		return fmt.Sprintf("3XNN: Skip next instruction if register V%s equals 0x%s", matches[1], matches[2])
	}

	if regExp_4XNN.MatchString(instructionText) {
		matches := regExp_4XNN.FindStringSubmatch(instructionText)
		return fmt.Sprintf("4XNN: Skip next instruction if register V%s NOT equals 0x%s", matches[1], matches[2])
	}

	if regExp_5XY0.MatchString(instructionText) {
		matches := regExp_5XY0.FindStringSubmatch(instructionText)
	...
	if regExp_8XY0.MatchString(instructionText) {
		matches := regExp_8XY0.FindStringSubmatch(instructionText)
		return fmt.Sprintf("8XY0: V%s is set to value of V%s. V%s is not affected.", matches[1], matches[2], matches[2])
	}

	if regExp_8XY1.MatchString(instructionText) {
		matches := regExp_8XY1.FindStringSubmatch(instructionText)
	...
	if regExp_8XY2.MatchString(instructionText) {
		matches := regExp_8XY2.FindStringSubmatch(instructionText)
	...
	if regExp_8XY3.MatchString(instructionText) {
		matches := regExp_8XY3.FindStringSubmatch(instructionText)
	...
	if regExp_8XY4.MatchString(instructionText) {
		matches := regExp_8XY4.FindStringSubmatch(instructionText)
	...
	if regExp_8XY5.MatchString(instructionText) {
		matches := regExp_8XY5.FindStringSubmatch(instructionText)
	...
	if regExp_8XY6.MatchString(instructionText) {
		matches := regExp_8XY6.FindStringSubmatch(instructionText)
	...
	if regExp_8XYE.MatchString(instructionText) {
		matches := regExp_8XYE.FindStringSubmatch(instructionText)
	...
	if regExp_9XY0.MatchString(instructionText) {
		matches := regExp_9XY0.FindStringSubmatch(instructionText)
	...
	if regExp_BNNN.MatchString(instructionText) {
		matches := regExp_BNNN.FindStringSubmatch(instructionText)
	...
	if regExp_FX33.MatchString(instructionText) {
		matches := regExp_FX33.FindStringSubmatch(instructionText)
	...
	if regExp_FX55.MatchString(instructionText) {
		matches := regExp_FX55.FindStringSubmatch(instructionText)
	...
	if regExp_FX65.MatchString(instructionText) {
		matches := regExp_FX65.FindStringSubmatch(instructionText)
